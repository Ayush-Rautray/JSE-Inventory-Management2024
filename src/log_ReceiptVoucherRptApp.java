...
class ReceiptVoucherRptWin implements ActionListener{
    JFrame f1;
    JPanel p1;
    ...
    public void doConnect() {
        ...
        try {//step3
            ...
            rs=stmSelect.executeQuery("select * from   LOG_TBLRECEIPTVOUCHER  ");
            rs.last();
            tot=rs.getRow();
            ...
            while(rs.next()){
                ...
                dataCompany[rw][8]=rs.getString("RMODE");
...
class log_ReceiptVoucherRptApp{
