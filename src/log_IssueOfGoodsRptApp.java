...
//log_IssueOfGoodsCustomerRptApp
class IssueOfGoodsRptWin implements ActionListener{
    JFrame f1;
    JPanel p1;
    ...
    int slno,rw,tot;
    Font fnt1;
    String colHead[]={"Slno","Invoice Number","Invoice Date","Order Number","Order Date","Retailer Name","Locality","City","State","Product Type","Slno","Product Code","Product Name","Product Size","MRP","Invoice Quantity","Amount","Discount%","Discount Amount","GST%","GST Amount","Net Amount" };


    public IssueOfGoodsRptWin(){
    ...
    public void doConnect() {
        ...
        try {//step3
            ...
            rs=stmSelect.executeQuery("select * from   LOG_TBLISSUEOFGOODS  ");
            rs.last();
            tot=rs.getRow();
            ...
            while(rs.next()){
                ...
                dataCompany[rw][5]=rs.getString("RNAME");
