...
class StockRegIssueOfGoodsCustomerCIWin implements ActionListener{
    JFrame f1;
    JPanel p1;
    ...
    public StockRegIssueOfGoodsCustomerCIWin(){
    ...
    public void doConnect() {
        ...
        try {//step3
            ...
            while(rsCombo.next()){
                strCombo=rsCombo.getString("CUSID");
                strCombo=strCombo.trim();
                string[i]=strCombo;
                i=i+1;
            }
            value=(String)dlg.showInputDialog(f1,"Enter  Customer ID ","Searching",1,null,string,null);
            lblHead.setText("Issue Of Goods "+" [ "+value+" ]");
            rs=stmSelect.executeQuery("select * from   LOG_TBLISSUEOFGOODSCUSTOMER where CUSID='"+value+"' ");
...
class log_StockRegIssueOfGoodsCustomerCIApp{
    public static void main(String []args){
        StockRegIssueOfGoodsCustomerCIWin obj;
        obj =new  StockRegIssueOfGoodsCustomerCIWin();
    }
