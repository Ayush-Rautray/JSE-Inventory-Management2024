...
class StockRptIssueOfGoodsWin implements ActionListener{
    JFrame f1;
    JPanel p1;
    ...
    public StockRptIssueOfGoodsWin(){
    ...
    public void doConnect() {
        ...
        try {//step3
            ...
            lblHead.setText("Issue Of Goods "+" [ "+rname+" ]");
            rs=stmSelect.executeQuery("select * from   LOG_TBLISSUEOFGOODS where RNAME='"+rname+"'  ");
            rs.last();
            tot=rs.getRow();
...
class log_StockRptIssueOfGoodsRApp{
    public static void main(String []args){
        StockRptIssueOfGoodsWin obj;
        obj =new  StockRptIssueOfGoodsWin();
    }
