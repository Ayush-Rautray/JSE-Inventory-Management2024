...
class StockRegIssueOfGoodsCustomerINWin implements ActionListener{
    JFrame f1;
    JPanel p1;
    ...
    public StockRegIssueOfGoodsCustomerINWin(){
    ...
    public void doConnect() {
        ...
        try {//step3
            ...
            rs=stmSelect.executeQuery("select * from   LOG_TBLISSUEOFGOODSCUSTOMER where IVNUM='"+value+"' ");
...
class log_StockRegIssueOfGoodsCustomerINApp{
    public static void main(String []args){
        StockRegIssueOfGoodsCustomerINWin obj;
        obj =new  StockRegIssueOfGoodsCustomerINWin();
    }
