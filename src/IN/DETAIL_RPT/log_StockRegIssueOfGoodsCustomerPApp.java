...
class StockRegIssueOfGoodsCustomerPWin implements ActionListener{
    JFrame f1;
    JPanel p1;
    ...
    public StockRegIssueOfGoodsCustomerPWin(){
    ...
    public void doConnect() {
        ...
        try {//step3
            ...
            lblHead.setText("ISSUE OF GOODS CUSTOMER "+" [ "+pcode+" ]");
            rs=stmSelect.executeQuery("select * from   LOG_TBLISSUEOFGOODSCUSTOMER where PCODE='"+pcode+"' ");
...
class log_StockRegIssueOfGoodsCustomerPApp{
    public static void main(String []args){
        StockRegIssueOfGoodsCustomerPWin obj;
        obj =new  StockRegIssueOfGoodsCustomerPWin();
    }
