...
class StockRptIssueOfGoodsIDWin implements ActionListener{
    JFrame f1;
    JPanel p1;
    ...
    public StockRptIssueOfGoodsIDWin(){
    ...
    public void doConnect() {
        ...
        try {//step3
            ...
            rs=stmSelect.executeQuery("select * from   LOG_TBLISSUEOFGOODS where IVDATE='"+value+"'  ");
...
class log_StockRptIssueOfGoodsIDApp{
    public static void main(String []args){
        StockRptIssueOfGoodsIDWin obj;
        obj =new  StockRptIssueOfGoodsIDWin();
    }
