...
class StockRptIssueOfGoodsPWin implements ActionListener{
    JFrame f1;
    JPanel p1;
    ...
    public StockRptIssueOfGoodsPWin(){
    ...
    public void doConnect() {
        ...
        try {//step3
            ...
            lblHead.setText("Issue Of Goods "+" [ "+pcode+" ]");
            rs=stmSelect.executeQuery("select * from   LOG_TBLISSUEOFGOODS  where PCODE='"+pcode+"'  ");
            rs.last();
            tot=rs.getRow();
...
class log_StockRptIssueOfGoodsPApp{
    public static void main(String []args){
        StockRptIssueOfGoodsPWin obj;
        obj =new  StockRptIssueOfGoodsPWin();
    }
