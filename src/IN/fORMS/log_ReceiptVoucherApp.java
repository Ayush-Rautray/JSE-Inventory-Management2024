...
class ReceiptVoucherWin implements ActionListener{
    JFrame f1;
    FlowLayout flw,flw1;
    JPanel p1,p2,p3;
    GridLayout gl94;
    ...
    JLabel lblHeader,lblVoucherNo,lblRName,lblCode,lblVDate,lblLocality,lblCity,lblState,lblRMode,lblTPayment,lblTDate,lblBName,lblAmt;
    ...
    JComboBox comboRName,comboPMode,comboBName;
    ...
    Connection conn;
    Statement stmCombo,stmSelect,stmSave,stmUpdate,stmDelete,stmSearching,stmGetVNum;
    ResultSet rsUser,rsComCode,rsCombo,rsGetVNum;
    String RetName,strVNum,strVDate,strRName,strCode,strLocality,strState,strCity,strRRMode,strTrans,strTDate,strBName,strAmt,str,strVNum1,strSearching;


    public ReceiptVoucherWin(){
        ...
        lblHeader= new JLabel("Receipt Voucher  ");
        ...
        lblAmt.setFont(fnt2);
        lblRMode=new JLabel("Receipt Mode");
        lblRMode.setFont(fnt2);
    ...
    public void doConnect() {
        ...
        try {//step3
            ...
            rsUser=stmSelect.executeQuery("select * from  LOG_TBLRECEIPTVOUCHER order by VNUM ");   //order by PCODE
    ...
    public void getVNum(){
        ...
        try{
            ...
            rsGetVNum=stmGetVNum.executeQuery("select count(VNUM) as VNUM from LOG_TBLRECEIPTVOUCHER");
            rsGetVNum.next();
    ...
    public void createRNameCombo(){
        //System.out.println("Here...");
        try {
            stmCombo= conn.createStatement();
            rsCombo= stmCombo.executeQuery("select * from LOG_TBLRETAILER order by RCODE");
            str="--select--";
            comboRName.addItem(str);
            while(rsCombo.next()){

                RetName = rsCombo.getString("RNAME");
                RetName=RetName.trim();
                comboRName.addItem(RetName);
            }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == btnClear) {
            ...
            strRRMode=comboPMode.getSelectedItem().toString();
            strRRMode=strRRMode.trim();
            strTrans=txtTPayment.getText();
            strTrans=strTrans.trim();
            strTDate=txtTDate.getText();
            strTDate=strTDate.trim();
            ...
            try{
                ...
                stmSave.executeUpdate("insert into  LOG_TBLRECEIPTVOUCHER values('"+strVNum+"','"+strVDate+"','"+strRName+"','"+strCode+"','"+strLocality+"','"+strState+"','"+strCity+"','"+strRRMode+"','"+strTrans+"','"+strTDate+"','"+strBName+"','"+strAmt+"')");
            ...
            try{
                if(rsUser.isLast()){
                    ...
                    strRRMode=rsUser.getString("RMODE");
                    ...
                    strRRMode=strRRMode.trim();
                    comboPMode.setSelectedItem(strRRMode);
        ...
        //LAST DATA
            ...
            try{
                ...
                if(option==0){
                    ...
                    stmDelete.executeUpdate("delete from LOG_TBLRECEIPTVOUCHER where  VNUM='"+strVNum1+"'");
        ...
        //SELECT-->
            ...
            try{
                ...
                rsComCode=stmSearching.executeQuery("select * from LOG_TBLRECEIPTVOUCHER where VNUM='"+strSearching+"'");

                if(rsComCode.next()){

                    strVNum=rsComCode.getString("VNUM");
                    strTDate=rsComCode.getString("VDATE");
                    strRName=rsComCode.getString("RNAME");
                    ...
                    strRRMode=rsComCode.getString("RMODE");
            ...
            try {
                ...
                if(option==0){
                    stmUpdate.executeUpdate("update LOG_TBLRECEIPTVOUCHER  set VNUM='"+strVNum+"',VDATE='"+strVDate+"',RNAME ='"+strRName+"',CODE ='"+strCode+"',LOCALITY='"+strLocality+"', CITY='"+strCity+"', STATE='"+strState+"',RMODE='"+strRRMode+"',TRANS='"+strTrans+"',BNAME='"+strBName+"', AMT='"+strAmt+"' where VNUM= '"+strVNum1+"'");
...
/*	create table LOG_TBLRECEIPTVOUCHER(VNUM number(7),VDATE char(50),RNAME char(50),CODE char(50),LOCALITY char(50),STATE 	char(50),CITY char(50),RMODE char(50),TRANS char(50),TDATE char(50),BNAME char(50),AMT number(7,2));
 */